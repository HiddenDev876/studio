...
import { improveWriting, type ImproveWritingInput } from "@/ai/flows/improve-writing";
...
type PolishEmailFormValues = z.infer<typeof formSchema>;
...
export function PolishEmailClient() {
  ...
  const form = useForm<PolishEmailFormValues>({
  ...
  async function onSubmit(data: PolishEmailFormValues) {
    setIsLoading(true);
    setImprovedText(null);
    try {
      const input: ImproveWritingInput = { text: data.text };
