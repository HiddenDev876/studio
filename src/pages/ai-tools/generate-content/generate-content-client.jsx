...
// Removed: import { generateContent } from "@/ai/flows/generate-content";
...
async function callGenerateContentFlow(input) {
  const response = await fetch(`${GENKIT_API_BASE_URL}/generateContentFlow`, {
    method: 'POST',
...
export function GenerateContentClient() {
  ...
  async function onSubmit(data) {
    ...
    try {
      ...
      const result = await callGenerateContentFlow(input);
      setGeneratedContent(result.generatedContent);
      toast({
        title: "Content Generated!",
        description: result.progress || "New content has been successfully generated by AI.",
      });
    } catch (error) {
      console.error("Error generating content:", error);
      toast({
        title: "Error Generating Content",
        description: error.message || "Failed to generate content. Please check console and ensure Genkit server is running.",
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
