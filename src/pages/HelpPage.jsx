    ...
    <div className="space-y-12">
      ...
      <section className="grid md:grid-cols-3 gap-8 py-12">
        ...
        <Card className="text-center shadow-lg">
          ...
          <CardContent>
            <CardDescription>
              Find answers to common questions in our <Link to="/faq" className="text-primary hover:underline">FAQ section</Link>.
            </CardDescription>
          </CardContent>
        </Card>
        <Card className="text-center shadow-lg">
          ...
          <CardContent>
            <CardDescription>
              Can't find an answer? <Link to="/contact" className="text-primary hover:underline">Contact our support team</Link>.
            </CardDescription>
          </CardContent>
        </Card>
      </section>
