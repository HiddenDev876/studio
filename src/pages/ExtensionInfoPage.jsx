    ...
    <div className="space-y-12">
      ...
      <section className="py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <Card className="shadow-lg">
            ...
            <CardContent>
              <p className="text-muted-foreground mb-2">Open `extension/popup.js` and ensure `API_BASE_URL` points to where your AI backend is running. (Note: This app's conversion simplified API calls, a real backend is needed for the extension).</p>
      ...
      <section className="text-center py-12 bg-secondary/50 rounded-lg">
        ...
        <p className="text-lg text-muted-foreground max-w-xl mx-auto mb-4">
          This extension is currently set up for local development and a conceptual backend. For production use, you would need to:
        </p>
        <ul className="list-disc list-inside text-muted-foreground max-w-xl mx-auto text-left mb-6">
            <li>Deploy a backend server for your Genkit AI flows.</li>
            <li>Update `API_BASE_URL` in `extension/manifest.json` to your deployed backend's URL.</li>
